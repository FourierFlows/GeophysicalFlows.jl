...
"""
    energy_dissipation_hyperviscosity(prob, ξ, nξ)
...
"""
    energy_dissipation_hypoviscosity(prob, ξ, nξ)
...
"""
    enstrophy_dissipation(prob, ξ, nξ)
...
"""
    enstrophy_dissipation_hyperviscosity(prob, ξ, nξ)
...
"""
    enstrophy_dissipation_hypoviscosity(prob, ξ, nξ)
